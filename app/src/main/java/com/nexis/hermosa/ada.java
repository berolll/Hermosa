    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHarita.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Uri uri=Uri.parse("geo:40.9937997,28.6860509?q=Avcılar Metrobüs");
        ...
        Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.adavideo);
        ...
        btnkat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(ada.this,adaKayit.class);
                kalan--;
                String kalann=String.valueOf(kalan);
                txtKalanhak.setText("kalan kişi sayısı: "+kalann);
                Toast.makeText(ada.this,"kalan kontenjan: "+kalan,Toast.LENGTH_LONG).show();
