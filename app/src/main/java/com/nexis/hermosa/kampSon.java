...
public class kampSon extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kamp_son);
        AlertDialog.Builder builder = new AlertDialog.Builder(kampSon.this);
        builder.setTitle("");
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder.setPositiveButton("EVET", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        sendmail(kisia,"ETKİNLİK BİLGİLENDİRME","---KAMP---\n"+
                                "Adres : Üniversite, 34320 Avcılar/İstanbul\n"+
                                "Tarih : 05.09.2022\n"+
                                "Saat : 15.00");
                    }
                });
                builder.setNegativeButton("HAYIR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        finish();
                        Intent intent=new Intent(kampSon.this,Etkinlik.class);
    ...
    private void sendmail(String[] eMail,String konu,String mesaj){
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(kampSon.this);
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder1.setNegativeButton("HAYIR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Intent intent=new Intent(kampSon.this,MapsActivity.class);
                        startActivity(intent);
                    }
                });
                builder1.show();
