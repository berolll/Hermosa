...
public class macson extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_macson);
        AlertDialog.Builder builder = new AlertDialog.Builder(macson.this);
        builder.setTitle("");
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder.setPositiveButton("EVET", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        sendmail(kisia,"ETKİNLİK BİLGİLENDİRME","---BEŞİKTAŞ-TRABZONSPOR MAÇI---\n"+
                                " Adres : Vişnezade, Dolmabahçe Cd. No:1, 34357 Beşiktaş/İstanbul\n"+
                                "Tarih : 23.02.2022\n"+
                                "Saat : 19.00");
                    }
                });
                builder.setNegativeButton("HAYIR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        finish();
                        Intent intent=new Intent(macson.this,Etkinlik2.class);
    ...
    private void sendmail(String[] eMail,String konu,String mesaj){
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(macson.this);
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder1.setNegativeButton("HAYIR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Intent intent=new Intent(macson.this,MapsActivity.class);
                        startActivity(intent);
                    }
                });
                builder1.show();
