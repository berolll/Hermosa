...
public class tiyatroson extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tiyatroson);
        AlertDialog.Builder builder = new AlertDialog.Builder(tiyatroson.this);
        builder.setTitle("");
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder.setPositiveButton("EVET", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        sendmail(kisia,"ETKİNLİK BİLGİLENDİRME","---TİYATRO---\n"+
                                " Adres : Sinanpaşa Mah Has Fırın Cad, Kazan Sk. No:3, 34353 Beşiktaş/İstanbul\n"+
                                "Tarih : 25.04.2022\n"+
                                "Saat : 20.30");
                    }
                });
                builder.setNegativeButton("HAYIR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        finish();
                        Intent intent=new Intent(tiyatroson.this,Etkinlik2.class);
    ...
    private void sendmail(String[] eMail,String konu,String mesaj){
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(tiyatroson.this);
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder1.setNegativeButton("HAYIR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Intent intent=new Intent(tiyatroson.this,MapsActivity.class);
                        startActivity(intent);
                    }
                });
                builder1.show();
