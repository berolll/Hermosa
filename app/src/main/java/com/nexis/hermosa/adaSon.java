...
public class adaSon extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ada_son);
        AlertDialog.Builder builder = new AlertDialog.Builder(adaSon.this);
        builder.setTitle("");
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder.setPositiveButton("EVET", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        sendmail(kisia,"ETKİNLİK BİLGİLENDİRME","---BÜYÜK ADA TURU---\n"+
                                "Kalkış yeri:Üniversite, 34320 Avcılar/İstanbul\n"+
                                "Tarih : 18.03.2022\n"+
                                "Saat : 07.00");
                    }
                });
                builder.setNegativeButton("HAYIR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        finish();
                        Intent intent=new Intent(adaSon.this,Etkinlik.class);
    ...
    private void sendmail(String[] eMail,String konu,String mesaj){
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(adaSon.this);
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                builder1.setNegativeButton("HAYIR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Intent intent=new Intent(adaSon.this,MapsActivity.class);
                        startActivity(intent);
                    }
                });
                builder1.show();
